...
export default function CreateStoryPage() {
  ...
  // Show back button when not on step 1 or 5
  const showBack = step > 1 && step < 5 && !showChildrenList;

  return (
    <div className="page-container-no-tabs">
      <Header showBack={showBack} onBack={prevStep} title="Create Story" />
                ...
                <div className="space-y-3 flex-1 overflow-y-auto">
                  {children.map((child, index) => (
                    <button
                      ...
                      className={`w-full dark-card p-4 text-left transition-all ${
                  ...
                  <button
                    ...
                    className="w-full dark-card-subtle p-4 text-left border-2 border-dashed border-gray-600"
                  >
                    <div className="flex items-center gap-4">
            ...
            <div className={`step-content ${getAnimationClass()}`}>
              <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
                ...
                <div className="dark-card p-6">
                  <div className="flex gap-2 mb-4 p-1 dark-card-subtle rounded-xl">
                    <button
                      type="button"
          ...
          {step === 3 && !showChildrenList && (
            <div className={`step-content ${getAnimationClass()}`}>
              <div className="flex-1 flex flex-col max-w-md mx-auto w-full">
                ...
                <div className="dark-card p-6 space-y-5 flex-1">
                  <div>
                    <label className="block text-sm font-medium mb-2">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {THEMES.map((t) => (
                        <button
                          ...
                          className={`dark-card-subtle px-3 py-3 text-sm flex flex-col items-center gap-2 transition-all ${
                            formData.theme === t.id
                              ? "ring-2 ring-purple-500"
                              : ""
                          }`}
                        >
                          <span className="text-2xl">{THEME_EMOJIS[t.id]}</span>
          ...
          {step === 5 && !showChildrenList && (
            <div className={`step-content ${getAnimationClass()}`}>
              <div className="flex-1 flex flex-col items-center justify-center max-w-md mx-auto w-full">
                <div className="dark-card p-10 text-center w-full">
                  {error ? (
                    <>
                      <div className="mb-6">
